(function ($) {
  ...
  | 18. List And Grid View
  | 19. Dynamic contact form
  | 20. Smooth Page Scroll
  | 21. AOS Animation
  |
  */
  ...
  function classToggle() {
    $(".cs_filter_size_list input").on("click", function () {
  ...
  function countdownInit() {
    const dateString = $("#countdown").data("target-date");
  ...
  function priceRangeInit() {
    $("#priceRangeSlider").ionRangeSlider({
      ...
      min: 0,
      max: 100,
      from: $("#priceRangeSlider").data("min-price"),
      to: $("#priceRangeSlider").data("max-price"),
      prefix: "$",
      grid: false,
    ...
    function updateDisplay(data) {
      $("#selectedPrice").text("$" + data.from_pretty + " - " + data.to_pretty);
    }
  }
  /*=============================================================
    18. List And Grid View
  ...
  function listAndGridView() {
    $(".cs_grid_view").on("click", function () {
      $(this).addClass("active").siblings().removeClass("active");
      $(".cs_products_grid").addClass("active");
      $(".cs_product_item").addClass("cs_type_1");
    });

    $(".cs_list_view").on("click", function () {
      $(this).addClass("active").siblings().removeClass("active");
      $(".cs_products_grid").removeClass("active");
      $(".cs_product_item").removeClass("cs_type_1");
    });
  }
  /*=============================================================
    19. Dynamic contact form
