!function(i) {
    ...
    )).prototype.addSlide = s.prototype.slickAdd = function(t, s, e) {
        var o = this;
        if ("boolean" == typeof s)
            e = s,
            s = null;
    ...
    s.prototype.changeSlide = function(t, s) {
        var e, o, n = i(t.currentTarget);
        switch (n.is("a") && t.preventDefault(),
        n.is("li") || (n = n.closest("li")),
        e = this.slideCount % this.options.slidesToScroll != 0 ? 0 : (this.slideCount - this.currentSlide) % this.options.slidesToScroll,
        t.data.message) {
        case "previous":
        ...
        case "next":
            ...
            break;
        case "index":
            var l = 0 === t.data.index ? 0 : t.data.index || n.index() * this.options.slidesToScroll;
    ...
    s.prototype.checkNavigable = function(i) {
        var t, s;
        if (s = 0,
        i > (t = this.getNavigableIndexes())[t.length - 1])
            i = t[t.length - 1];
        else
            for (var e in t) {
                if (i < t[e]) {
    ...
    s.prototype.cleanUpRows = function() {
        var i;
        this.options.rows > 0 && ((i = this.$slides.children().children()).removeAttr("style"),
    ...
    s.prototype.initDotEvents = function() {
        ...
        !0 === this.options.dots && !0 === this.options.pauseOnDotsHover && this.slideCount > this.options.slidesToShow && i("li", this.$dots).on("mouseenter.slick", i.proxy(this.interrupt, this, !0)).on("mouseleave.slick", i.proxy(this.interrupt, this, !1))
    }
    ,
    ...
    s.prototype.lazyLoad = function() {
        ...
        if (!0 === o.options.centerMode ? !0 === o.options.infinite ? e = (s = o.currentSlide + (o.options.slidesToShow / 2 + 1)) + o.options.slidesToShow + 2 : (s = Math.max(0, o.currentSlide - (o.options.slidesToShow / 2 + 1)),
        e = o.options.slidesToShow / 2 + 1 + 2 + o.currentSlide) : (e = Math.ceil((s = o.options.infinite ? o.options.slidesToShow + o.currentSlide : o.currentSlide) + o.options.slidesToShow),
        !0 === o.options.fade && (s > 0 && s--,
        e <= o.slideCount && e++)),
        t = o.$slider.find(".slick-slide").slice(s, e),
        "anticipated" === o.options.lazyLoad)
            for (var l = s - 1, r = e, d = o.$slider.find(".slick-slide"), a = 0; a < o.options.slidesToScroll; a++)
    ...
    s.prototype.slideHandler = function(i, t, s) {
        ...
        !(!0 === a.animating && !0 === a.options.waitForAnimate || !0 === a.options.fade && a.currentSlide === i)) {
            ...
            !1 === a.options.infinite && !1 === a.options.centerMode && (i < 0 || i > a.getDotCount() * a.options.slidesToScroll))
                ...
                !0 !== s && a.slideCount > a.options.slidesToShow ? a.animateSlide(l, function() {
                    a.postSlide(e)
                }) : a.postSlide(e));
                ...
                !0 !== s && a.slideCount > a.options.slidesToShow ? a.animateSlide(r, function() {
                    a.postSlide(o)
                }) : a.postSlide(o)
            }
        }
