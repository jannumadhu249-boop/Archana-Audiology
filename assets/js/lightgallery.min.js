    ...
    !function() {
        ...
        t.prototype.isVideo = function(e, t) {
            ...
            !e)
                ...
                !1);
            var o, s = e.match(/\/\/(?:www\.)?youtu(?:\.be|be\.com|be-nocookie\.com)\/(?:watch\?v=|embed\/)?([a-z0-9\-\_\%]+)/i), i = e.match(/\/\/(?:www\.)?vimeo.com\/([0-9a-z\-_]+)/i), l = e.match(/\/\/(?:www\.)?dai.ly\/([0-9a-z\-_]+)/i), r = e.match(/\/\/(?:www\.)?(?:vk\.com|vkontakte\.ru)\/(?:video_ext\.php\?)(.*)/i);
            return s ? {
                youtube: s
            } : i ? {
                vimeo: i
        ...
        t.prototype.addHtml = function(t) {
            var o, s, i = null;
            if (this.s.dynamic ? this.s.dynamicEl[t].subHtmlUrl ? o = this.s.dynamicEl[t].subHtmlUrl : i = this.s.dynamicEl[t].subHtml : (s = this.$items.eq(t)).attr("data-sub-html-url") ? o = s.attr("data-sub-html-url") : (i = s.attr("data-sub-html"),
        ...
        t.prototype.loadContent = function(t, o, s) {
            var i, l, r, a, n, d, c = this, h = !1, u = function(t) {
            ...
            c.s.dynamic ? (c.s.dynamicEl[t].poster && (h = !0,
            r = c.s.dynamicEl[t].poster),
            d = c.s.dynamicEl[t].html,
            l = c.s.dynamicEl[t].src,
            c.s.dynamicEl[t].responsive && u(c.s.dynamicEl[t].responsive.split(",")),
            a = c.s.dynamicEl[t].srcset,
            n = c.s.dynamicEl[t].sizes) : (c.$items.eq(t).attr("data-poster") && (h = !0,
            r = c.$items.eq(t).attr("data-poster")),
            d = c.$items.eq(t).attr("data-html"),
            l = c.$items.eq(t).attr("href") || c.$items.eq(t).attr("data-src"),
            c.$items.eq(t).attr("data-responsive") && u(c.$items.eq(t).attr("data-responsive").split(",")),
            ...
            if (!c.$slide.eq(t).hasClass("lg-loaded")) {
                if (g)
                    ...
                    m ? (c.$slide.eq(t).prepend('<div class="lg-video-cont "><div class="lg-video"></div></div>'),
        ...
        t.prototype.slide = function(t, o, s, i) {
            var l = this.$outer.find(".lg-current").index()
              , r = this;
            if (!r.lGalleryOn || l !== t) {
                var a, n, d, c = this.$slide.length, h = r.lGalleryOn ? this.s.speed : 0;
                !r.lgBusy && (this.s.download && ((a = r.s.dynamic ? !1 !== r.s.dynamicEl[t].downloadUrl && (r.s.dynamicEl[t].downloadUrl || r.s.dynamicEl[t].src) : "false" !== r.$items.eq(t).attr("data-download-url") && (r.$items.eq(t).attr("data-download-url") || r.$items.eq(t).attr("href") || r.$items.eq(t).attr("data-src"))) ? (e("#lg-download").attr("href", a),
                ...
                n = c - 1)) : (n = 0,
                d = 1),
                "prev" === i ? r.$slide.eq(d).addClass("lg-next-slide") : r.$slide.eq(n).addClass("lg-prev-slide"),
                r.$slide.eq(t).addClass("lg-current")) : (r.$outer.addClass("lg-no-trans"),
        ...
        t.prototype.touchEnd = function(e) {
            ...
            setTimeout(function() {
                ...
                e < 0 && Math.abs(e) > t.s.swipeThreshold ? t.goToNextSlide(!0) : e > 0 && Math.abs(e) > t.s.swipeThreshold ? t.goToPrevSlide(!0) : 5 > Math.abs(e) && t.$el.trigger("onSlideClick.lg"),
        ...
        t.prototype.enableDrag = function() {
            ...
            t.s.enableDrag && t.doCss() && (t.$slide.on("mousedown.lg", function(s) {
                t.$outer.hasClass("lg-zoomed") || t.lgBusy || e(s.target).text().trim() || (s.preventDefault(),
                t.manageSwipeClass(),
                o = s.pageX,
                i = !0,
...
function(e, t) {
    ...
    (o = function(o) {
        ...
        (t = i.core.$outer.find(".lg-pager-cont")).on("click.lg touchend.lg", function() {
            var t = e(this);
...
function(e, t) {
    ...
    o.prototype.build = function() {
        ...
        s.core.$outer.find(".lg").append('<div class="lg-thumb-outer"><div class="lg-thumb lg-group"></div></div>'),
    ...
    o.prototype.enableThumbDrag = function() {
        ...
        e(window).on("mousemove.lg.thumb", function(e) {
            ...
            (r -= s - o) > t.thumbTotalWidth - t.thumbOuterWidth && (r = t.thumbTotalWidth - t.thumbOuterWidth),
            r < 0 && (r = 0),
            t.setTranslate(r))
        }),
    ...
    o.prototype.enableThumbSwipe = function() {
        ...
        e.core.$outer.find(".lg-thumb").on("touchmove.lg", function(l) {
            ...
            i = e.left,
            (i -= o - t) > e.thumbTotalWidth - e.thumbOuterWidth && (i = e.thumbTotalWidth - e.thumbOuterWidth),
            i < 0 && (i = 0),
            e.setTranslate(i))
        }),
...
function(e, t) {
    ...
    !function() {
        ...
        function s(t, o, s) {
            var i, l = this.core.$slide.eq(o), r = l.find(".lg-youtube").get(0), a = l.find(".lg-vimeo").get(0), n = l.find(".lg-dailymotion").get(0), d = l.find(".lg-vk").get(0), c = l.find(".lg-html5").get(0);
            if (r)
            ...
            i = this.core.s.dynamic ? this.core.s.dynamicEl[s].src : this.core.$items.eq(s).attr("href") || this.core.$items.eq(s).attr("data-src");
            var g = this.core.isVideo(i, s) || {};
            (g.youtube || g.vimeo || g.dailymotion || g.vk) && this.core.$outer.addClass("lg-hide-download")
        }
        var i = {
            videoMaxWidth: "855px",
        ...
        l.prototype.loadVideoOnclick = function(e) {
            ...
            if (e.find(".lg-object").hasClass("lg-has-poster") && e.find(".lg-object").is(":visible")) {
                if (e.hasClass("lg-has-video")) {
                    ...
                    t.core.s.dynamic ? c(n = t.core.s.dynamicEl[t.core.index].src, d = t.core.s.dynamicEl[t.core.index].html) : c(n = t.core.$items.eq(t.core.index).attr("href") || t.core.$items.eq(t.core.index).attr("data-src"), d = t.core.$items.eq(t.core.index).attr("data-html"));
...
function(e, t) {
    ...
    s = {
        ...
        enableZoomAfter: 300,
        useLeftForZoom: (t = !1,
        (o = navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./)) && 54 > parseInt(o[2], 10) && (t = !0),
        t)
    },
    (i = function(t) {
        return this.core = e(t).data("lightGallery"),
        ...
        var s = 1
          ...
          , r = function(o, i, r, a) {
            ...
            d = t.core.s.dynamic ? t.core.s.dynamicEl[r].width || i[0].naturalWidth || c : t.core.$items.eq(r).attr("data-width") || i[0].naturalWidth || c,
            t.core.$outer.hasClass("lg-zoomed") ? s = 1 : d > c && (s = (n = d / c) || 2),
    ...
    i.prototype.zoomSwipe = function() {
        ...
        e.core.$slide.on("touchstart.lg", function(o) {
            if (e.core.$outer.hasClass("lg-zoomed")) {
                ...
                ((i = s.prop("offsetWidth") * s.attr("data-scale") > e.core.$outer.find(".lg").width()) || l) && (o.preventDefault(),
                t = {
    ...
    i.prototype.touchendZoom = function(e, t, o, s) {
        var i = this.core.$slide.eq(this.core.index).find(".lg-img-wrap")
          ...
          , n = (this.core.$outer.find(".lg").height() - l.prop("offsetHeight")) / 2
          , d = Math.abs(l.prop("offsetHeight") * Math.abs(l.attr("data-scale")) - this.core.$outer.find(".lg").height() + n)
          , c = (this.core.$outer.find(".lg").width() - l.prop("offsetWidth")) / 2
          , h = Math.abs(l.prop("offsetWidth") * Math.abs(l.attr("data-scale")) - this.core.$outer.find(".lg").width() + c);
        (Math.abs(t.x - e.x) > 15 || Math.abs(t.y - e.y) > 15) && (s && (a <= -d ? a = -d : a >= -n && (a = -n)),
        o && (r <= -h ? r = -h : r >= -c && (r = -c)),
        s ? i.attr("data-y", Math.abs(a)) : a = -Math.abs(i.attr("data-y")),
        o ? i.attr("data-x", Math.abs(r)) : r = -Math.abs(i.attr("data-x")),
        this.core.s.useLeftForZoom ? i.css({
            left: r + "px",
            top: a + "px"
...
function(e, t) {
    ...
    (o = function(o) {
        ...
        e(window).on("hashchange.lg.hash", function() {
            var e = parseInt((t = window.location.hash).split("&slide=")[1], 10);
            t.indexOf("lg=" + o.core.s.galleryId) > -1 ? o.core.slide(e, !1, !1) : o.core.lGalleryOn && o.core.destroy()
        })
    }
    ,
    o.prototype.destroy = function() {
        this.core.s.hash && (this.oldHash && 0 > this.oldHash.indexOf("lg=" + this.core.s.galleryId) ? history.replaceState ? history.replaceState(null, null, this.oldHash) : window.location.hash = this.oldHash : history.replaceState ? history.replaceState(null, document.title, window.location.pathname + window.location.search) : window.location.hash = "",
...
function(e) {
    ...
    function t(t) {
        ...
        0 !== u || 0 !== h) {
            ...
            if (g = Math.max(Math.abs(u), Math.abs(h)),
            (!l || l > g) && (l = g,
            s(r, g) && (l /= 40)),
            s(r, g) && (d /= 40,
            h /= 40,
    ...
    var i, l, r = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"], a = "onwheel"in document || document.documentMode >= 9 ? ["wheel"] : ["mousewheel", "DomMouseScroll", "MozMousePixelScroll"], n = Array.prototype.slice;
    if (e.event.fixHooks)
        for (var d = r.length; d; )
            e.event.fixHooks[r[--d]] = e.event.mouseHooks;
    var c = e.event.special.mousewheel = {
        ...
        teardown: function() {
            if (this.removeEventListener)
                for (var o = a.length; o; )
                    this.removeEventListener(a[--o], t, !1);
            else
        ...
        getLineHeight: function(t) {
            ...
            parseInt(s.css("fontSize"), 10) || parseInt(o.css("fontSize"), 10) || 16
        },
